...
/**
 * Extension of the standard JAX-RS {@link javax.ws.rs.core.Response}, providing access to a {@link HateoasResponseBuilder} rather
 * than the standard {@link javax.ws.rs.core.Response.ResponseBuilder}.
 *
...
public abstract class HateoasResponse extends Response {
     ...
     * {@link javax.ws.rs.core.Response.ResponseBuilder} instance and obtain a Response from that.
     */
     ...
     * available via
     * {@link javax.ws.rs.ext.RuntimeDelegate#createHeaderDelegate(Class)}
     ...
     *                 base URI of the application (see {@link javax.ws.rs.core.UriInfo#getBaseUri}).
     * @return a new ResponseBuilder
     * @throws IllegalArgumentException
     *          if location is null
     */
    ...
    /**
     * Extension of the standard JAX-RS {@link javax.ws.rs.core.Response.ResponseBuilder}, adding methods to specify hypermedia in responses.
     *
...
//
         ...
         * making sure that the links will be applied at each end node.
         *
         * Note that the order in witch the {@link com.jayway.jaxrs.hateoas.ParamExpander}ers are defined determines
         ...
         * @return this
         * @see com.jayway.jaxrs.hateoas.ParamExpander
         */
...
//
        ...
        /**
         * Construct a {@link com.jayway.jaxrs.hateoas.HateoasLink} for the supplied id, building the URI using the specified parameters.
         *
         * @param id     the @Linkable id of the target method.
         * @param rel    the relation of the linked resource in the current context.
         ...
         * responsibility to wrap the actual entity with {@link javax.ws.rs.core.GenericEntity}
         ...
         *                 {@link javax.ws.rs.core.UriInfo#getBaseUri}). If null any existing value
