...
public abstract class JerseyHateoasApplication extends PackagesResourceConfig {
    ...
    /**
     * Creates a new Application with he given {@link com.jayway.jaxrs.hateoas.HateoasVerbosity} level.
     *
     * @param verbosity the verbosity level to use in the application
     * @param props     properties to be passed to {@link com.sun.jersey.api.core.PackagesResourceConfig} constructor
     */
