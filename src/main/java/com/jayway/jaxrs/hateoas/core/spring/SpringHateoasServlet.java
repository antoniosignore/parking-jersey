...
/**
 * Adds HATEOAS capability to the Jersey {@link com.sun.jersey.spi.spring.container.servlet.SpringServlet}. Use this instead of the standard SpringServlet to add
...
//            System.out.println("property = " + o.toString());
//        }
